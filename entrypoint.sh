...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'f1914322-5e72-47eb-8e2c-880176f338c3'}
...
ARGO_AUTH='{"AccountTag":"c66100991466bc178659886d309a7a11","TunnelSecret":"owqWvqBoc7lO7/kSn8r3Cf0Nx6+4HwNTeUuio/59ut4=","TunnelID":"ed67a888-d9c9-4295-abfd-0a1972f0b709"}'
ARGO_DOMAIN=mybackdomain.cloud.goodluck.cloudns.ph
